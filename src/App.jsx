  ...
  return (
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"var(--bg)",minHeight:"100vh",color:"var(--text)"}}>
      ...
      <main className="main-content" style={{marginLeft:240,padding:26,minHeight:"100vh"}}>
          ...
          <div className="fu">
            ...
            <PH title={t.inventory} subtitle={`${parts.length} parts · ${lowStock.length} low`}
              action={<div style={{display:"flex",gap:8,alignItems:"center"}}>
                ...
                {(role==="admin"||role==="branch_admin")&&<button className="btn btn-ghost btn-sm" onClick={()=>openM("ocrScanPart")} title="Photograph a part's stamped number and look it up (test feature)">📷 Scan Part</button>}
        ...
        {/* ── PART PHOTOS ── */}
        {tab==="partPhotos"&&(
          <PartPhotoCapturePage parts={parts} partFitments={partFitments} vehicles={vehicles} settings={{...settings,...(currentBranch||{})}} onSavePhotos={savePartPhotos} onSaveField={savePartField} onRefresh={()=>refreshTables("parts")} t={t}/>
        )}
        ...
        {tab==="loginlogs"&&role==="admin"&&(
          <div className="fu">
            ...
            {(()=>{
              ...
              const LAND=[
                [[-80,-59.6],[-81,-60.2],[-80.9,-64.5],[-80.3,-66.3],[-80.4,-61.9],[-79.6,-60.6],[-80,-59.6]],
                [[-79.5,-159.2],[-79.6,-161.1],[-79.3,-162.4],[-78.6,-163.7],[-78.2,-163.1],[-78.4,-161.2],[-79,-159.5],[-79.5,-159.2]],
                [[-78,-45.2],[-78.5,-43.9],[-79.1,-43.5],[-80,-43.3],[-80.6,-46.5],[-81,-50.5],[-81,-52.9],[-80.6,-54.2],[-80.2,-54],[-79.9,-51.9],[-79.6,-51],[-78,-48.7],[-77.8,-46.7],[-78,-45.2]],
                ...
                [[-71.9,-99],[-72.1,-97.9],[-72,-96.8],[-72.5,-96.2],[-72.4,-97],[-72.5,-98.2],[-72.4,-99.4],[-72.5,-100.8],[-72.3,-101.8],[-71.9,-102.3],[-71.7,-101.7],[-71.9,-100.4],[-71.9,-99]],
                [[-71,-68.5],[-71.4,-68.3],[-72.2,-68.8],[-72.5,-71.1],[-72.5,-72.4],[-72.1,-71.9],[-72.4,-74.2],[-72.1,-75],[-71.7,-75],[-71.3,-73.9],[-71.2,-72.1],[-70.3,-71.7],[-69.5,-71.7],[-69,-71.2],[-68.9,-70.3],[-69.3,-69.7],[-70.5,-68.7],[-71,-68.5]],
                [[-64.2,-58.6],[-64.8,-62],[-66.2,-62.1],[-68,-65.7],[-70.7,-61.8],[-73.7,-60.8],[-76.6,-70.6],[-76.7,-77.2],[-77.9,-73.7],[-78.4,-77.9],[-79.2,-78],[-80.3,-75.4],[-81.7,-63.3],[-83.2,-58.2],[-81.7,-49.8],[-82.1,-42.8],[-80.3,-28.5],[-79.3,-29.7],[-79.5,-35.6],[-78.3,-35.8],[-75.1,-17.5],[-74.5,-15.7],[-73.9,-16.5],[-73.1,-15.4],[-71.3,-10.3],[-71.7,-7.4],[-70.9,-6.9],[-71.6,-0.2],[-69.9,7.7],[-70.8,10.8],[-69.9,17],[-70.5,27.1],[-69.7,32],[-68.5,33.9],[-69.8,38.6],[-65.8,54.5],[-68,61.4],[-67.4,64.1],[-67.9,68.9
                [[10.1,-60.9],[10,-61.8],[10.1,-61.9],[10.4,-61.7],[10.8,-61.7],[10.9,-61.1],[10.9,-60.9],[10.1,-60.9]],
                [[10.3,124],[10,123.6],[9.3,123.3],[9,123],[9.7,122.4],[10,122.6],[10.3,122.8],[10.9,122.9],[10.9,123.5],[10.3,123.3],[11.2,124.1],[10.3,124]],
                [[9.3,118.5],[8.4,117.2],[10.4,119],[11.4,119.5],[10.6,119.7],[10,119],[9.3,118.5]],
                [[11.9,121.9],[11.6,122.5],[11.6,123.1],[11.2,123.1],[10.7,122.6],[10.4,122],[10.9,122],[11.4,122],[11.9,121.9]],
                [[12.2,125.5],[11,125.8],[11.3,125],[11,125],[10.4,125.3],[10.1,124.8],[10.8,124.8],[10.9,124.5],[11.5,124.3],[11.4,124.9],[11.8,124.9],[12.6,124.3],[12.5,125.2],[12.2,125.5]],
                [[13.1,121.5],[12.2,121.3],[12.7,120.8],[13.5,120.3],[13.4,121.2],[13.1,121.5]],
                [[18.5,121.3],[18.2,121.9],[18.5,122.2],[17.8,122.2],[17.1,122.5],[16.3,122.3],[15.9,121.7],[15.1,121.5],[14.3,121.7],[14.2,122.3],[14.3,122.7],[13.8,124],[13.2,123.9],[13,124.2],[12.5,124.1],[13,123.3],[13.6,122.9],[13.2,122.7],[13.8,122],[13.6,121.1],[13.9,120.6],[14.3,120.7],[14.5,121],[14.8,120.7],[14.4,120.6],[15,120.1],[15.4,119.9],[16.4,119.9],[16,120.3],[17.6,120.4],[18.5,120.7],[18.5,121.3]],
                [[18.2,-65.6],[18,-65.8],[18,-66.6],[17.9,-67.2],[18.4,-67.2],[18.5,-67.1],[18.5,-66.3],[18.4,-65.8],[18.2,-65.6]],
                [[17.9,-76.9],[17.7,-77.2],[17.9,-77.8],[18.2,-78.3],[18.5,-78.2],[18.5,-77.8],[18.5,-77.6],[18.4,-76.9],[18.2,-76.4],[17.9,-76.2],[17.9,-76.9]],
                [[19.9,-72.6],[19.7,-71.7],[19.9,-71.6],[19.9,-70.8],[19.6,-70],[19.3,-69.8],[19.3,-69.2],[19,-69.3],[19,-68.8],[18.6,-68.3],[18.2,-68.7],[18.4,-69.2],[18.4,-70],[18.2,-70.1],[18.2,-70.5],[18.4,-70.7],[18.3,-71],[17.6,-71.4],[17.8,-71.7],[18,-71.7],[18.2,-72.4],[18.2,-73.5],[18,-73.9],[18.3,-74.5],[18.7,-74.4],[18.4,-72.7],[18.7,-72.3],[19.1,-72.8],[19.5,-72.8],[19.6,-73.4],[19.9,-73.2],[19.9,-72.6]],
                [[18.7,110.3],[18.2,109.5],[18.5,108.7],[19.4,108.6],[19.8,109.1],[20.1,110.2],[20.1,110.8],[19.7,111],[19.3,110.6],[18.7,110.3]],
                [[19.1,-155.5],[18.9,-155.7],[19.1,-155.9],[19.3,-155.9],[19.7,-156.1],[19.8,-156],[20,-155.9],[20.2,-155.9],[20.3,-155.9],[20.2,-155.8],[20.1,-155.4],[20,-155.2],[19.9,-155.1],[19.5,-154.8],[19.2,-155.2],[19.1,-155.5]],
                [[20.6,-156.1],[20.6,-156.4],[20.8,-156.6],[20.9,-156.7],[21,-156.6],[20.9,-156.3],[20.8,-156],[20.6,-156.1]],
                [[21.2,-156.8],[21.1,-156.8],[21.1,-157.3],[21.2,-157.3],[21.2,-156.8]],
                [[21.3,-157.7],[21.3,-157.8],[21.3,-158.1],[21.5,-158.3],[21.6,-158.3],[21.7,-158],[21.7,-157.9],[21.3,-157.7]],
                [[22,-159.3],[21.9,-159.5],[22.1,-159.8],[22.1,-159.7],[22.2,-159.6],[22.2,-159.4],[22,-159.3]],
                [[22.8,-79.7],[22.4,-79.3],[22.5,-78.3],[21.2,-76.5],[21,-75.6],[20.7,-75.7],[20.7,-74.9],[20.3,-74.2],[20.1,-74.3],[19.9,-75],[20,-76.3],[19.9,-77.8],[20.4,-77.1],[20.7,-77.5],[20.7,-78.1],[21,-78.5],[21.6,-78.7],[21.8,-80.2],[22,-80.5],[22.2,-81.8],[22.4,-82.2],[22.6,-81.8],[22.7,-82.8],[22.2,-83.5],[22.2,-83.9],[21.9,-84.1],[21.9,-85],[22.2,-84.4],[22.6,-84.2],[23,-83.3],[23.2,-82.3],[23.1,-80.6],[22.8,-79.7]],
                ...
                [[34.1,134.6],[33.8,134.8],[33.2,134.2],[33.5,133.8],[33.3,133.3],[32.7,133],[33,132.4],[33.5,132.4],[34.1,132.9],[33.9,133.5],[34.4,133.9],[34.1,134.6]],
                [[35.7,34.6],[35.2,33.9],[35.1,34],[35,34],[34.6,33],[34.7,32.5],[35.1,32.3],[35.1,32.7],[35.1,32.8],[35.4,32.9],[35.4,33.7],[35.7,34.6]],
                [[35.7,23.7],[35.4,24.2],[35.4,25],[35.4,25.8],[35.2,25.7],[35.3,26.3],[35,26.2],[34.9,24.7],[35.1,24.7],[35.3,23.5],[35.7,23.7]],
                [[38.2,15.5],[37.4,15.2],[37.1,15.3],[36.6,15.1],[37,14.3],[37.1,13.8],[37.6,12.4],[38.1,12.6],[38,13.7],[38.1,14.8],[38.2,15.5]],
                [[41.2,9.2],[40.5,9.8],[39.2,9.7],[39.2,9.2],[38.9,8.8],[39.2,8.4],[40.4,8.4],[41,8.2],[40.9,8.7],[41.2,9.2]],
                [[37.1,141],[36.3,140.6],[35.8,140.8],[35.1,140.3],[34.6,137.2],[33.5,135.8],[33.8,135.1],[34.6,135.1],[34.4,133.3],[33.9,132.2],[33.9,131],[33.1,132],[31.5,131.3],[31,130.7],[31.4,130.2],[32.3,130.4],[32.6,129.8],[33.3,129.4],[33.6,130.4],[35.4,132.6],[35.7,134.6],[35.5,135.7],[37.3,136.7],[36.8,137.4],[38.2,139.4],[39.4,140.1],[40.6,139.9],[41.2,140.3],[41.4,141.4],[39.2,141.9],[38.2,141],[37.1,141]],
                [[42.2,9.6],[41.4,9.2],[41.6,8.8],[42.3,8.5],[42.6,8.7],[43,9.4],[42.2,9.6]],
                [[72.8,-93.2],[72,-94.3],[72.1,-95.4],[72.9,-96],[73.4,-96],[73.9,-95.5],[74.1,-94.5],[74.1,-92.4],[73.9,-90.5],[73,-92],[72.8,-93.2]],
                [[71.4,-120.5],[70.9,-123.1],[71.3,-123.6],[71.9,-125.9],[73.7,-123.9],[74.3,-124.9],[74.4,-121.5],[74.2,-120.1],[74.2,-117.6],[73.5,-115.5],[72.5,-119.2],[71.8,-120.5],[71.4,-120.5]],
                ...
                [[76.7,-98.5],[76.3,-97.7],[75.7,-97.7],[75,-98.2],[74.9,-99.8],[75.1,-100.9],[75.6,-100.9],[75.6,-102.5],[76.3,-102.6],[76.3,-101.5],[76.6,-100],[76.6,-98.6],[76.7,-98.5]],
                [[76.2,-108.2],[75.8,-107.8],[76,-106.9],[76,-105.9],[75.5,-105.7],[75,-106.3],[74.9,-109.7],[74.4,-112.2],[74.4,-113.7],[74.7,-113.9],[75.2,-111.8],[75,-116.3],[75.2,-117.7],[76.2,-116.3],[76.5,-115.4],[76.1,-112.6],[75.5,-110.8],[75.5,-109.1],[76.4,-110.5],[76.8,-109.6],[76.7,-108.5],[76.2,-108.2]],
                [[70.7,57.5],[70.8,53.7],[71.2,53.4],[71.5,51.6],[72,51.5],[72.2,52.5],[72.8,52.4],[73.6,54.4],[73.7,53.5],[74.6,55.9],[75.1,55.6],[76.3,61.2],[76.9,68.2],[76.5,68.9],[75.3,61.6],[74.3,58.5],[72.4,55.4],[71.5,55.6],[70.7,57.5]],
                [[77.1,-94.7],[76.8,-93.6],[76.8,-91.6],[76.4,-90.7],[76.1,-91],[75.6,-89.2],[75.5,-86.4],[75.8,-82.8],[75.7,-81.1],[75.3,-80.1],[74.9,-79.8],[74.4,-81.9],[74.6,-83.2],[74.4,-88.2],[74.8,-92.4],[75.4,-92.8],[75.9,-92.9],[76.3,-93.9],[76.4,-96],[76.8,-97.1],[77.2,-96.7],[77.1,-94.7]],
                [[77.6,-116.2],[76.9,-116.3],[76.5,-117.1],[76.5,-118],[75.9,-121.5],[76.1,-122.9],[76.9,-121.2],[77.5,-119.1],[77.5,-117.6],[77.6,-116.2]],
                [[77,107],[75.8,114.1],[74.2,109.4],[73.1,119],[73.6,127],[70.8,131.3],[71.8,132.3],[71.5,139.9],[72.4,139.1],[72.8,140.5],[72.2,149.5],[70.8,153],[70.9,159],[69.4,160.9],[69.6,167.8],[68.7,169.6],[69,170.8],[69.7,170],[70.1,170.5],[69.9,175.7],[69,180],[65,180],[64.6,177.4],[63,179.4],[62.3,179.2],[61.7,173.7],[59.9,170.3],[60.6,168.9],[59.9,163.5],[58.2,162],[57.6,163.2],[56.2,163.1],[56.1,162.1],[54.9,162.1],[53,158.5],[51,156.8],[55.4,155.4],[56.8,155.9],[61.1,163.7],[62.6,164.5],[60.5,160.1],[61.8,159.3],[61.4,156.7],[59.8,154.2],[59.1,155],[58.8,151.3],[59.5,151.3],[59.7,149.8],[59,142.2],[54.7,135.1],[53.8,138.2],[54.2,139.9],[52.2,141.4],[48.4,140.1],[45.1,136.9],[42.8,133.5],[43.3,132.3],[42.6,130.
.1],[45.4,12.3],[44.1,12.6],[40.2,18.5],[40.4,16.9],[39.8,16.4],[38.9,17.1],[38,16.1],[40,15.4],[44.4,8.9],[43.1,6.5],[43.1,3.1],[41.9,3],[41,0.8],[39.3,-0.3],[38.7,0.1],[36.7,-2.1],[35.9,-5.4],[36.9,-6.5],[36.9,-8.9],[43,-9.4],[44,-1.4],[46,-1.2],[48.7,-4.6],[48.6,-1.6],[49.8,-1.9],[49.3,-1],[50.1,1.3],[53.1,4.7],[53.5,8.1],[54,8.8],[55.5,8.1],[57.1,8.5],[57.7,10.6],[56.5,10.9],[55.5,9.7],[54,10.9],[54.5,12.5],[53.8,14.1],[54.9,17.6],[54.4,19.7],[55.2,21.3],[57.4,21.6],[57,24.1],[58.4,24.4],[59.2,23.3],[60,29.1],[59.8,22.9],[60.7,21.3],[63.2,21.5],[65.1,25.4],[66,23.9],[65.7,22.2],[64.4,21.4],[62.7,17.8],[61.3,17.1],[60.1,18.8],[58.7,16.8],[56.1,15.9],[55.4,12.9],[59.5,10.4],[58.3,8.4],[58.6,5.7],[62,5],[64.5,10.5],[68.6,16.4],[71,24.5],[71.2,28.2],[70.5,31.3],[70.2,30],[69.6,31.1],[69.1,36.5],[67.5,41.1],[66.8,41.1],[66,38.4],[66.6,33.2],[65.9,34.8],[64.4,34.9],[63.8,37],[64.8,36.5],[65.1,37.2],[64.5,39.6],[64.8,40.4],[65.5,39.8],[66.5,42.1],[66.1,43.9],[66.8,44.5],[68.6,43.5],[68.3,46.3],[67.7,46.8],[67.6,45.6],[66.7,46.3],[68.9,53.7],[68.8,54.5],[68.2,53.5],[68.9,58.8],[68.3,59.9],[68.9,61.1],[69.5,60],[69.9,60.6],[68.1,68.5],[68.6,69.2],[69.5,66.9],[71,66.7],[72.8,69.2],[72.8,72.6],[71.4,71.8],[70.4,72.8],[69,72.6],[68.4,73.7],[66.3,71.3],[66.2,72.4],[67.8,75.1],[69,74.9],[69.6,73.6],[70.6,74.4],[71.4,73.1],[72.1,74.9],[72.8,74.7],[72.3,75.7],[71.3,75.3],[72.3,77.6],[71.8,81.5],[73.6,80.5],[73.9,86.8],[74.5,86],[75.1,87.2],[77.4,106.1],[77.1,104.7],[77,107]],
                ...
                [[78.6,-109.7],[78.4,-110.9],[78.4,-112.5],[78.6,-112.5],[78.8,-111.5],[78.8,-111],[78.6,-109.7]],
                [[78.1,-95.8],[77.9,-97.3],[78.1,-98.1],[78.5,-98.6],[78.9,-98.6],[78.8,-97.3],[78.8,-96.8],[78.4,-95.6],[78.1,-95.8]],
                [[78.3,-100.1],[77.9,-99.7],[78.3,-102.9],[78.4,-105.2],[78.7,-104.2],[78.9,-105.4],[79.3,-105.5],[79.2,-103.5],[78.8,-100.8],[78.3,-100.1]],
                [[78.3,105.1],[77.9,99.4],[79.2,101.3],[79.3,102.8],[78.7,105.4],[78.3,105.1]],
              ];
              const SA_POLY=[[-28.6,16.3],[-28.1,16.8],[-28.4,17.2],[-28.8,17.4],[-29,18.5],[-29,19],[-28.5,19.9],[-24.8,19.9],[-24.9,20.2],[-25.9,20.8],[-26.5,20.7],[-26.8,20.9],[-26.7,21.6],[-26,22.6],[-25.5,22.8],[-25.3,23.3],[-25.4,23.7],[-25.7,24.2],[-25.7,25],[-25.5,25.7],[-24.7,25.9],[-24.6,26.5],[-24.2,26.8],[-23.6,27.1],[-22.8,28],[-22.1,29.4],[-22.1,29.8],[-22.3,30.3],[-22.2,30.7],[-22.3,31.2],[-24.4,31.9],[-25.8,31.8],[-25.7,31],[-26.4,30.7],[-26.7,30.7],[-27.3,31.3],[-27.2,31.9],[-26.7,32.1],[-26.7,32.8],[-28.3,32.5],[-28.8,32.2],[-29.4,31.3],[-31.1,30.1],[-32.8,28.2],[-33.2,27.5],[-33.6,26.4],[-33.7,25.9],[-33.9,25.8],[-33.8,25.2],[-34,24.7],[-33.8,23.6],[-33.9,22.6],[-34.3,21.5],[-34.4,20.7],[-34.8,20.1],[-34.8,19.6],[-34.5,19.2],[-34.4,18.9],[-34,18.4],[-34.1,18.4],[-33.9,18.2],[-33.3,18.3],[-32.6,17.9],[-32.4,18.2],[-31.7,18.2],[-29.9,17.1],[-28.6,16.3]];
              ...
              // Build country-level data. CTY_LL/PROV_LL/BBOX above are curated positions kept for
              // markets we already know; any country not in those tables gets its pin computed as
              ...
              loginLogs.filter(l=>l.user_role!=="admin"&&l.user_role!=="demo").forEach(l=>{
                ...
                const d=ctData[cn];
                d.count++;
                d.users.push(l.username);
                const provName=l.province||CITY_PROVINCE[l.city]||"";
                if(provName){
                  if(!d.provinces[provName])d.provinces[provName]={count:0,latSum:0,lonSum:0,llCount:0};
                  d.provinces[provName].count++;
                }
                if(l.lat!=null&&l.lon!=null){
                  const la=+l.lat,lo=+l.lon;
                  d.latSum+=la;d.lonSum+=lo;d.llCount++;
                  d.latMin=d.latMin===null?la:Math.min(d.latMin,la);
                  d.latMax=d.latMax===null?la:Math.max(d.latMax,la);
                  d.lonMin=d.lonMin===null?lo:Math.min(d.lonMin,lo);
                  d.lonMax=d.lonMax===null?lo:Math.max(d.lonMax,lo);
                  if(provName){const pd=d.provinces[provName];pd.latSum+=la;pd.lonSum+=lo;pd.llCount++;}
                }
                const fd=firstLogin[l.username]||"";
                if(fd.startsWith(currentMonth))d.newCount++; else d.oldCount++;
              });
              Object.entries(ctData).forEach(([cn,d])=>{
                d.ll=CTY_LL[cn]||(d.llCount>0?[d.latSum/d.llCount,d.lonSum/d.llCount]:null);
                d.bbox=BBOX[cn]||(d.llCount>0?[d.latMin,d.latMax,d.lonMin,d.lonMax]:null);
              });
              ...
              const getVB=cn=>{
                const b=ctData[cn]?.bbox;
                if(b&&b[0]!=null){const padT=4,padB=14,padL=12,padR=5,x=mX(b[2]-padL),y=mY(b[1]+padT),w=mX(b[3]+padR)-x,h=mY(b[0]-padB)-y;return`${x.toFixed(1)} ${y.toFixed(1)} ${Math.max(w,60).toFixed(1)} ${Math.max(h,40).toFixed(1)}`;}
              ...
              return(
                <div className="card" style={{overflow:"hidden",marginBottom:16,padding:0}}>
                  ...
                  {!sc?(
                    ...
                    const provLogs=loginLogs.filter(l=>l.user_role!=="admin"&&l.user_role!=="demo"&&(l.province||CITY_PROVINCE[l.city])===selectedMapProvince);
                    ...
                    <div style={{background:"#080f1a"}}>
                      <div style={window.innerWidth<640?{display:"flex",flexDirection:"column"}:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:0}}>
                        ...
                        <MapBase viewBox={getVB(sc)}>
                          {scd&&Object.entries(scd.provinces).map(([prov,pd],i)=>{
                            const ll=PROV_LL[prov]||(pd.llCount>0?[pd.latSum/pd.llCount,pd.lonSum/pd.llCount]:null);
                            if(!ll)return null;
                            ...
                            return(
                              <g key={i} transform={`translate(${cx},${cy})`} onClick={()=>{setSelectedMapProvince(prov);setSelectedMapCity(null);}} style={{cursor:"pointer"}}>
                                ...
                                <text textAnchor="middle" dominantBaseline="central" fill="white" fontSize={r*0.85} fontWeight="700" fontFamily="DM Mono,monospace">{pd.count}</text>
                                <text y={r+1.6} textAnchor="middle" fill="#fbbf24" fontSize={1.4} fontWeight="600">{prov}</text>
                              </g>
                            );
                          })}
                          {scd&&Object.keys(scd.provinces).length===0&&scd.ll&&(
                            <g transform={`translate(${mX(scd.ll[1]).toFixed(1)},${mY(scd.ll[0]).toFixed(1)})`}>
                        ...
                        <div style={{display:"flex",flexDirection:"column",borderLeft:window.innerWidth<640?"none":"1px solid #0f1e2e",borderTop:window.innerWidth<640?"1px solid #0f1e2e":"none"}}>
                          ...
                          {scd&&Object.keys(scd.provinces).length>0&&(
                            <div style={{padding:"10px 14px",borderBottom:"1px solid #0f1e2e"}}>
                              ...
                              {Object.entries(scd.provinces).sort((a,b)=>b[1].count-a[1].count).map(([prov,pd])=>(
                                <div key={prov} onClick={()=>{setSelectedMapProvince(prov);setSelectedMapCity(null);}} style={{display:"grid",gridTemplateColumns:"1fr 32px",alignItems:"center",gap:8,marginBottom:6,cursor:"pointer"}}>
                                  <div>
                                    <div style={{display:"flex",justifyContent:"space-between",marginBottom:3}}>
                                      ...
                                      <span style={{fontSize:11,fontWeight:700,color:"#fbbf24"}}>{pd.count}</span>
                                    </div>
                                    <div style={{background:"#0f1e2e",borderRadius:4,height:5,overflow:"hidden"}}>
                                      <div style={{width:`${Math.round(pd.count/scd.count*100)}%`,height:"100%",background:"#d97706",borderRadius:4}}/>
                                    </div>
                                  </div>
                                  <span style={{fontSize:10,color:"#64748b",textAlign:"right"}}>{Math.round(pd.count/scd.count*100)}%</span>
                                </div>
                              ))}
                            </div>
                          )}
      ...
      {isOpen("ocrScanPart")&&<PartOcrScanModal parts={parts} onClose={()=>closeM("ocrScanPart")} onGoToPart={(part)=>{closeM("ocrScanPart");setTimeout(()=>openM("editPart",{...part,_tab:"info"}),0);}}/>}
