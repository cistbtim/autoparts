...
// arrive with context instead of a bare message.
  ...
  return (
    <>
      <button onClick={()=>setOpen(true)} title="Send feedback"
        style={{position:"fixed",right:18,bottom:18,zIndex:500,width:52,height:52,borderRadius:"50%",
          background:"linear-gradient(135deg,#f97316,#ea580c)",color:"#fff",border:"none",
          boxShadow:"0 4px 16px rgba(0,0,0,.3)",cursor:"pointer",fontSize:22,
