...
export const T = {
  en: {
    ...
    // Customer-facing quote approval page (public ?wsq= link)
    wsqApprovalTitle: "Workshop Quotation Approval",
    wsqApproved: "Quotation Approved!",
    wsqDeclined: "Quotation Declined",
    wsqApprovedMsg: "Thank you! We will proceed with the work as quoted. We will contact you shortly.",
    wsqDeclinedMsg: "Thank you for your response. We will get in touch to discuss alternatives.",
    wsqWorkItems: "Work Items",
    wsqNoItems: "No items found",
    wsqWorkshopNotes: "Workshop Notes",
    wsqYourMsg: "Your message (optional)",
    wsqMsgPlaceholder: "Any questions or comments for the workshop...",
    wsqDeclineBtn: "Decline",
    wsqApproveBtn: "Approve & Confirm",
    wsqSubmitting: "Submitting...",
    wsqContact: "Questions? Contact us:",
    ...
    wsqPdfDate: "Date",
    wsqPdfValidUntil: "Valid until",
    wsqPdfCustomer: "Customer",
    wsqPdfVehicle: "Vehicle",
    wsqPdfDescription: "Description",
    wsqPdfQty: "Qty",
    wsqPdfUnitPrice: "Unit Price",
    wsqPdfSubtotal: "Subtotal",
    wsqPdfVat: "VAT",
    wsqPdfTotal: "TOTAL",
    wsqPdfNotes: "Notes",
    wsqPdfMileage: "Mileage",
  },
};
