...
export function LoginPage({onLogin,t,lang,setLang,loadedSettings,langs=[],wsLoginOnly=false}) {
  ...
  const logLogin = async (u) => {
    try {
      ...
      await api.upsert("login_logs",{username:u.username||u.phone,user_role:u.role||"customer",ip_address:g.ip||"?",country:g.countryFull||"?",province:g.province||"",city:g.city||"",weather:wx.label||null,device,device_type,status:"success"});
    } catch {}
  };
